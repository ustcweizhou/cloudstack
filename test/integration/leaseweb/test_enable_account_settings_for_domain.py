...
""" tests for Domain settings enhancement (to add account settings) in 4.11.2-leaseweb
    ...
    JIRA ticket: https://jira.ocom.com/browse/CLSTACK-4601
...
class TestDedicatePublicIPRange(cloudstackTestCase):
    ...
    @attr(tags=["advanced", "advancedsg"], required_hardware="false")
    def test_01_enable_account_settings_for_domain(self):
        ...
        self.assertIsNotNone(configs, "Fail to get domain setting %s " % config_name)
        domain_value = int(configs[0].value)
        self.assertEqual(new_value, domain_value, "Domain setting is not equal to new value of ROOT domain setting")
        ...
        self.assertIsNotNone(configs, "Fail to get account setting %s " % config_name)
        account_value = int(configs[0].value)
        self.assertEqual(new_value, account_value, "Account setting is not equal to new value of ROOT domain setting")
        ...
        self.assertIsNotNone(configs, "Fail to get account setting %s " % config_name)
        account_value = int(configs[0].value)
        self.assertEqual(new_value, account_value, "Account setting is not equal to new value of domain setting")
