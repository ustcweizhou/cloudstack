...
# under the License.
""" tests for Domain settings enhancement (to add account settings) in 4.11.2-leaseweb

    JIRA ticket: https://jira.ocom.com/browse/CLSTACK-4665
...
class TestRestConfigurationSettings(cloudstackTestCase):
    ...
    def test_02_test_settings_for_account(self):
        ...
        config_name="account.default.storage.tag"
    ...
    def test_03_test_settings_for_cluster(self):
        ...
        config_name="host.maintenance.retries"
        configs = Configurations.list(
            self.apiclient,
            name=config_name,
    ...
    def test_06_test_settings_for_network(self):
        """
        1. Get the default value for the setting in network scope
        2. Change the default value to new value
        3. Make sure updated value is same as new value
        4. Reset the config value
        5. Make sure that current value is same as default value
        ...
        self.assertIsNotNone(self.network_offering, "Unable to create network offerings in the zone")
        ...
        self.assertIsNotNone(accounts, "Unable to find accounts in the zone")
        ...
        self.assertIsNotNone(isolated_network, "Unable to create a network")

        config_name="network.router.service.offering"
        new_value="12345"
        ...
        self.assertIsNotNone(configs, "Fail to get image store setting %s " % config_name)
        ...
        self.assertIsNotNone(configs, "Fail to get network setting %s " % config_name)
        ...
        self.assertIsNotNone(configs, "Failed to get network setting %s " % config_name)

        self.assertEqual(orig_value,
                         str(configs[0].value),
                         "Failed to reset the value for network")
    ...
    @attr(tags=["advanced"], required_hardware="false")
    def test_07_test_settings_for_vpc(self):
        """
        1. Get the default value for the setting vpc scope
        2. Change the default value to new value
        3. Make sure updated value is same as new value
        4. Reset the config value
        5. Make sure that current value is same as default value
        ...
        self.assertIsNotNone(self.vpc_off, "Unable to create vpc network offerings in the zone")
        ...
        self.vpc = VPC.create(
            ...
            domainid=accounts[0].domainid)

        self.assertIsNotNone(self.vpc, "Unable to create a vpc network")

        config_name = "vpc.router.service.offering"
        new_value = "12345"
        ...
        self.assertIsNotNone(configs, "Fail to get vpc setting %s " % config_name)
        ...
        self.assertIsNotNone(configs, "Failed to get vpc setting %s " % config_name)

        self.assertEqual(orig_value,
                         str(configs[0].value),
                         "Failed to reset the value for vpc")
